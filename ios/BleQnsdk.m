...
RCT_EXTERN_METHOD(buildUser:(NSString *)name birthday:(NSString *)birthday height:(NSInteger *)height gender:(NSString *)gender id:(NSString *)id unit:(NSInteger *)unit resolver: (RCTPromiseResolveBlock)resolve
